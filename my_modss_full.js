...
var Modss = {
	...
	var button = "<div style='position:relative' data-subtitle='modss_v".concat(manifest.version, " (21 Balansers, 17 in VIP)' class='full-start__button selector view--modss_online'>" + ico + "<span>" + this.title + "</span></div>");
        ...
        if (a.bal) {
          ...
          if (Lampa.Arrays.getKeys(sources).indexOf(a.source) !== -1) {
            ...
            Lampa.Modal.open({
              title: '',
              align: 'center',
              html: $('<div class="modssModal account-add-device loaded"><img src="http://lampa.stream/qr_bot.png" class="account-add-device__qr" style="padding: 0;margin-bottom: 0;background: #3c3e3f;"><div class="ad-server__text about" style="margin-bottom: 0;"><b>Надоело смотреть в плохом качестве?</b><br>Хочешь смотреть в <b style="color: #ffd402;">FHD</b> и <b style="color: #ffd402;">4K</b>? Сканируй код или переходи @modssmy_bot и подключай <b style="color: #02ff60;">Vip</b></div></div>'),
              onBack: function () {
                Lampa.Modal.close();
                Lampa.Controller.toggle(controller);
              }
	...
	function startPlugin() {
		...
		*/
		...
		manifest = {
			...
			description: 'Онлайн (21 Balansers, 17 in VIP)',
			component: 'modss_online',
